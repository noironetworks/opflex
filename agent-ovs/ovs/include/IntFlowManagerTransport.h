...
#ifndef OPFLEXAGENT_INTFLOWMANAGERTRANSPORT_H_
#define OPFLEXAGENT_INTFLOWMANAGERTRANSPORT_H_
 ...
 * modifications.
 */
class IntFlowManagerTransport : public SwitchStateHandler,
...
public:
     ...
     */
    IntFlowManagerTransport(Agent& agent,
     ...
     */
    static void
    actionTunnelMetadata(ActionBuilder& ab, IntFlowManagerTransport::EncapType type,
...
private:
     ...
     * Note that the flood group may be a bridge-domain directly
     *
...
#endif // OPFLEXAGENT_INTFLOWMANAGERTRANSPORT_H_
