...
/*
 * Implementation for PacketInHandlerTransport
 *
...
PacketInHandlerTransport::PacketInHandlerTransport(Agent& agent_,
                                 IntFlowManagerTransport& intFlowManager_)
...
static opt_output_act_t tunnelOutActions(IntFlowManagerTransport& intFlowManager,
                                         optional<URI>& egUri,
                                         uint32_t outPort) {
    ...
    if (egUri && (outPort == intFlowManager.getTunnelPort())) {
        outActions =
            ...
            IntFlowManagerTransport::actionTunnelMetadata(ab,
 ...
 */
void PacketInHandlerTransport::Handle(SwitchConnection* conn,
