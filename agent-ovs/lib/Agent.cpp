...
void Agent::start() {
	...
	framework.overrideObservableReporting(modelgbp::gbpe::EpToExtStatsCounter::CLASS_ID, false);
	framework.overrideObservableReporting(modelgbp::gbpe::ExtToEpStatsCounter::CLASS_ID, false);
    }
}
